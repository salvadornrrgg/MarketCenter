...
class EmailInvalido(ExcepcaoValidacao): #ainda nao e para agora
    def __init__(self):
        super().__init__(
            "Email inválido.",
...
class PasswordInvalida(ExcepcaoValidacao): #ainda nao e para agora
    def __init__(self):
        super().__init__(
            "Password inválida.",
...
class UtilizadorNaoAutenticado(ExcepcaoInterna): #ainda nao e para agora
    def __init__(self):
        super().__init__(
